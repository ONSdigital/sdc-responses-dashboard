...
function getReport(response) {
    const report = {
        ...
        "inProgress": {
            ...
            "tooltip": {
                "placement": "bottom",
                "title": "<strong>eQ</strong>: The number of cases where a questionnaire has been launched but not completed. <p /><strong>SEFT</strong>: The number of cases where a respondent has downloaded a collection instrument but not successfully uploaded the response."
            }
        },
        "completed": {
            "id": "completed",
